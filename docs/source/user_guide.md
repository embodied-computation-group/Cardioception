...
* [systole](https://github.com/embodied-computation-group/systole) can be installed with `pip install git+https://github.com/embodied-computation-group/systole.git`.
