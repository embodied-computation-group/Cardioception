...
```{r message=FALSE}
pacman::p_load(tidyverse,ggdist,psycho,caret,patchwork, gt, cowplot, grid,reticulate,cmdstanr)
np <- import("numpy")
```
...
working_directory = "/home/jespere/test_HRD/R-implementation-of-HRD"

#This line reads in a subject result file:
df = read_csv(file.path(working_directory,"data","subject1","HRD_final.txt"))
